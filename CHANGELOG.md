...
## v3.12.0 (2026-05-24) — metadata.ums + metadata.tvshows.ums
...
## v3.11.4 (2026-05-24) — metadata.tvshows.ums
- Настройка "Очистить кэш" в разделе "Расширенные": очистка FileCache по запросу пользователя

## v3.10.1 (2026-05-24) — metadata.ums
- Настройка "Очистить кэш" в разделе "Расширенные": очистка FileCache по запросу пользователя

## v3.11.3 (2026-05-24) — metadata.tvshows.ums
...
## v3.11.2 (2026-05-24) — metadata.tvshows.ums
...
## v3.11.1 (2026-05-24) — metadata.tvshows.ums
...
## v3.11.0 (2026-05-24) — metadata.tvshows.ums
...
## v3.10.0 (2026-05-24) — metadata.ums
- Теги наград (BL-10): парсинг OMDb Awards, теги Оскар/Глобус/Эмми/BAFTA/Канны, `setTags()` в Kodi
- Нормализация жанров (BL-11): маппинг 31 жанра KP рус→англ, настройка "Язык жанров"
...
## v3.9.0 (2026-05-24) — metadata.ums
